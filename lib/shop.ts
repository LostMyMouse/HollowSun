...
export function shopAccess(g:Game){const vendor=entities(g).find(e=>e.id==='brakk');return !g.combat&&g.hp>0&&!g.ending&&g.scene==='station'&&!!vendor&&distance(g.pos,vendor.pos)<=17;}
